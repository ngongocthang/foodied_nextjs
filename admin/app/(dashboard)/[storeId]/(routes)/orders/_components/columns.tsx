...
export const columns: ColumnDef<OrdersColumns>[] = [
  ...
  },
  {
    ...
    cell: ({row}) => {
      ...
      return <p className={cn("text-base font-semibold", 
  ...
  },
  {
    ...
    cell: ({row}) => {
      ...
      return <p className={cn("text-base font-semibold", isPaid ? "text-emerald-500" : "text-red-500")}>{isPaid ? "Paid" : "Not Paid"}</p>
    },
  },
  {
