...
export const POST = async (req : Request,
    ...
    try{
        ...
        await updateDoc(doc(db, "stores", params.storeId, "products", id), {
            ...productData, id, updatedAt : serverTimestamp()
        })
...
export const GET = async (req : Request,
    ...
    try{
       ...
       if(searchParams.has("isFeatured")){
        queryContrains.push(where("isFeatured", "==", searchParams.get("isFeatured") === "true" ? true : false))
       }
       if(searchParams.has("isArchived")){
        queryContrains.push(where("isArchived", "==", searchParams.get("isArchived") === "true" ? true : false))
       }
