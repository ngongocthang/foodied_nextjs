    ...
    return ( 
        ...
        <Container className="px-4 md:px-12">
            <section className="grid grid-cols-1 md: grid-cols-2 py-12 pt-16">
                <div className="flex flex-col items-start justify-start gap-4">
                    ...
                    <h2 className="text-5xl font-bold tracking-wider uppercase text-neutral-700 my-4">
                        Just Come To 
                        <span className="block py-4">Foodied & Order</span>
                    </h2>
                    <p className="text-base text-center md:text-left text-neutral-500 my-4">
                        Enjoy the best dishes from around the world, delivered to your doorstep every day!
                    </p>
                    <div className="my-4 flex text-center justify-center gap-6 w-full md:w-auto">
                        ...
                        <Link href={"/"}>
                        <Button className="px-8 md:px-16 py-4 md:py-6 rounded-full" variant="outline">
                            Explore More
                        </Button>
                        </Link>
                    </div>
            ...
            <section className="my-4 py-12 flex flex-col items-center justify-center">
                ...
                Choose us for unparalleled quality, reliability, and exceptional service at competitive prices, ensuring your satisfaction every step of the way.
                    {""}
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full my-6 mt-20">
                    <Card className="shadow-lg rounded-md border-none p-4 py-12 flex flex-col items-center justify-center gap-4">
                        ...
                        Fresh, nutritious options promoting wellness and vitality for a nourished lifestyle.
                        </CardDescription>
                    </Card>
                    {/*  */}
                    <Card className="shadow-lg rounded-md border-none p-4 py-12 flex flex-col items-center justify-center gap-4">
                        ...
                        <CardDescription className="text-center">
                        Uncompromising excellence, superior craftsmanship, and utmost satisfaction guaranteed in every product.
                        </CardDescription>
                    </Card>
                    {/*  */}
                    <Card className="shadow-lg rounded-md border-none p-4 py-12 flex flex-col items-center justify-center gap-4">
                        ...
                        <CardDescription className="text-center">
                        Swift, reliable service ensuring your products reach you promptly and conveniently.
                        </CardDescription>
                    </Card>
                </div>
            </section>
            ...
            <h2 className="text-5xl md:text-5xl font-bold tracking-wider uppercase text-neutral-700 my-4">
                ...
                <p className="w-full text-center md:w-[560px] text-base text-neutral-500 my-2">
                Culinary wizard crafting delectable masterpieces, infusing passion and creativity into every dish for an unforgettable dining experience.
                    {""}
                </p>
                {/* image  */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full my-6 mt-20">
