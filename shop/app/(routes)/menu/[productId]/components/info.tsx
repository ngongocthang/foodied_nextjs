...
const Info = ({product}: InfoProps) => {
    ...
    return <div>
        ...
        Our food products boast exceptional quality, prioritizing freshness, nutritional richness, and rigorous safety standards. We ensure premium ingredients, devoid of preservatives, delivering a delightful and wholesome culinary experience, earning customer trust and satisfaction.
        </p>
        </div>
        ...
        <Button onClick={() => addToCart(product)} className="w-full py-6 text-xl font-semibold hover:bg-hero hover:text-white flex items-center justify-center gap-3">
            Add to card <ShoppingCart className=" w-4 h-4"/>
        </Button>
    </div>;
}
