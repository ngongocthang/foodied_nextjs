    ...
    <Container>
      <div className="w-full  bg-hero/30 grid grid-cols-2 md:grid-cols-4 px-4 md:px-12 py-8">
        ...
        <div className="flex flex-col items-start justify-start gap-3">
          ...
          <p className="text-neutral-500 text-sm">+0349903731</p>
          <p className="text-neutral-500 text-sm">nnthang@gmail.com</p>
          <p className="text-neutral-500 text-sm">70_NguyenHue, Hue</p>
        </div>
      ...
      <div className="mx-auto py-8 ">
        <p className="text-center text-xs text-black">
          &copy; 2024 Foodied, Inc. All rights reserved
        </p>
      </div>
    </Container>
  </footer>
